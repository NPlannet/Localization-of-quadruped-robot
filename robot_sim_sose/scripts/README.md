...
| `record_robot_run.sh` | Attach to an existing bringup and record MCAP plus CPU/RAM data |
| `robot_evaluation_run.sh` | Start a complete mapper evaluation and recording run |
