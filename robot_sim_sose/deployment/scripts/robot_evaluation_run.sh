...
OUTPUT_ROOT=${OUTPUT_ROOT:-${WORKSPACE}/evaluation_runs}
...
Optional environment variables:
  OUTPUT_ROOT=/workspaces/robot_sim_sose/evaluation_runs
...
QOS_OVERRIDES=${WORKSPACE}/deployment/config/bag_record_qos.yaml
MONITOR_SCRIPT=${WORKSPACE}/deployment/scripts/monitor_robot_resources.py
